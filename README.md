...
## v0.4.4.43 installation

Install the complete module folder and reload Foundry. v0.4.4.43 corrects the live Foundry circular-Document failure found in the first Checkpoint 4 acceptance attempt. Run `docs/acceptance-crosshairs3d-v0.4.4.43.txt` as the primary GM; it exercises the production Item/CAT path without recursively traversing or freezing live Foundry Documents.
