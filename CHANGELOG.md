...
- Added role-specific presentation profiles with independent tint, sound asset, and volume. Only the originator profile currently has an assigned sound (`notification01.ogg`); responder/external audio slots are intentionally silent until distinct assets are supplied.
